# Generated by Django 4.0 on 2021-12-10 22:05
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_theme', models.CharField(
                    choices=[('1', 'product'), ('2', 'soft'), ('3', 'security'), ('4', 'other')], max_length=255)),
                ...
                ('opened_by', models.ForeignKey(
                    on_delete=models.SET(app_support.models.get_current_tc_user_object),
                    related_name='tickets', related_query_name='ticket', to='app_support.appuser')),
            ],
            options={
                'ordering': ['creation_date', 'is_closed', 'answered'],
            },
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('linked_ticket', models.ForeignKey(
                    ...
                    related_query_name='message', to='app_support.ticket')),
                ('linked_user', models.ForeignKey(
                    on_delete=models.SET(app_support.models.get_current_tc_user_object),
                    to='app_support.appuser')),
            ],
        ),
    ]
