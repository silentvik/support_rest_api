...
urlpatterns = [
    ...
    path('token/obtain/', TokenObtainPairView.as_view(), name='obtain_token'),  # simpleJWT
    path('token/refresh/', TokenRefreshView.as_view(), name='refresh_token'),  # simpleJWT
    ...
    # bonus (unnecessary, but perhaps convenient):
